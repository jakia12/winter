...
import { ag as ae, ah as ce, ai as le } from "./index.BCuxRot0.js";
/**
 ...
 **/ const fe = "http://www.w3.org/2000/svg",
  ...
  pe = {
    ...
    createElement: (t, e, n, s) => {
      const o =
        e === "svg"
          ? S.createElementNS(fe, t)
          : e === "mathml"
          ? S.createElementNS(ue, t)
  ...
  return I(e, {
    ...
    onLeave(l, m) {
      ...
      h(l, p),
        ...
        h(l, d),
        et(() => {
          l._isLeaving && (C(l, p), h(l, T), tt(U) || nt(l, s, Ot, v));
        }),
        b(U, [l, v]);
    },
    onEnterCancelled(l) {
...
const Qe = ({ linkToSection: t, isInstant: e = !1, isPreviewMode: n = !1 }) => {
  ...
  window.requestAnimationFrame(() => {
    n && i
      ? i.scrollTo({ top: f, behavior: c })
      : window.scrollTo({ top: f, behavior: c });
  });
};
export {
  vt as T,
