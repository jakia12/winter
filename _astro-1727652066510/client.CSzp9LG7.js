...
import { s as S, d as y, e as A } from "./scrollToSection.Dv7NeHSh.js";
import { af as w } from "./index.BCuxRot0.js";
const R = /\s|&nbsp;/g,
  $ = (t) => {
    try {
...
function L(t, e, n, o, s, a) {
  return h(), b("a", { href: t.to.path }, [_(t.$slots, "default")], 8, B);
}
...
function j(t) {
  ...
  if (typeof t == "object") {
    ...
    s
      ...
      a && S({ linkToSection: a, isInstant: n });
